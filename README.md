...
**Autors**: CC_Viper, CC_Magnetar, CC_OMSmolina, CC_TBlack.
...
* 1.0   (2013-12-26) Document inicial per CC_OMSmolina, CC_TBlack i CC_Viper.
...
Qualsevol canvi a aquest document ha de ser notificat a CC_Viper. No es permeten modificacions personals d'aquest document durant les partides oficials dels Cavallers del Cel. Qualsevol canvi en l'equipació per motius d'una missió específica no ha d'afectar els perfils guardats de forma oficial.